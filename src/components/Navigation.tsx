  ...
  return (
    <nav className={`backdrop-blur-md shadow-2xl border-b-4 transition-all duration-300 ${
      isOnamPage 
        ...
        : 'bg-serene-50/95 dark:bg-gray-900/95 border-serene-400 dark:border-serene-500'
    }`}>
          ...
          <Link to="/" className="flex items-center space-x-3">
            <div className={`w-12 h-12 rounded-full flex items-center justify-center shadow-xl border-2 border-white dark:border-gray-700 transition-all duration-300 ${
              isOnamPage 
                ...
                : 'bg-gradient-to-br from-serene-500 via-backwater-500 to-sage-500 dark:from-serene-400 dark:via-backwater-400 dark:to-sage-400'
            }`}>
            ...
            <div className="flex flex-col">
              <span className={`font-bold text-xl bg-clip-text text-transparent transition-all duration-300 ${
                isOnamPage 
                  ...
                  : 'bg-gradient-to-r from-serene-600 to-backwater-600 dark:from-serene-400 dark:to-backwater-400'
              }`}>
                Infinity Malayalees
              </span>
                ...
                className={`flex items-center space-x-2 px-4 py-3 rounded-xl text-sm font-bold transition-all duration-300 transform hover:scale-105 ${
                  ...
                  (path === '/events' && (location.pathname === '/onam-2025' || location.pathname === '/sadya-registration' || location.pathname === '/cultural-events'))
                    ? isOnamPage
                      ...
                      : 'bg-gradient-to-r from-serene-500 to-backwater-500 dark:from-serene-400 dark:to-backwater-400 text-white shadow-lg border-2 border-sage-300 dark:border-sage-400'
                    : `text-gray-700 dark:text-gray-300 hover:shadow-md transition-all duration-300 ${
                        isOnamPage
                          ...
                          : 'hover:text-serene-700 dark:hover:text-serene-400 hover:bg-gradient-to-r hover:from-serene-100 hover:to-backwater-100 dark:hover:from-gray-800 dark:hover:to-gray-700'
                      }`
                }`}
              >
                <Icon size={18} />
            ...
            <Link
              ...
              className={`flex items-center space-x-2 px-4 py-3 rounded-xl text-sm font-bold text-white transition-all duration-300 transform hover:scale-105 shadow-lg ${
                isOnamPage
                  ...
                  : 'bg-gradient-to-r from-serene-500 to-sage-500 dark:from-serene-400 dark:to-sage-400 hover:from-serene-600 hover:to-sage-600 dark:hover:from-serene-500 dark:hover:to-sage-500'
              }`}
            >
              <Users size={18} />
            ...
            <Link
              ...
              className={`flex items-center space-x-2 px-4 py-3 rounded-xl text-sm font-bold transition-all duration-300 transform hover:scale-105 hover:shadow-md ${
                isOnamPage
                  ...
                  : 'text-gray-700 dark:text-gray-300 hover:text-serene-700 dark:hover:text-serene-400 hover:bg-gradient-to-r hover:from-serene-100 hover:to-backwater-100 dark:hover:from-gray-800 dark:hover:to-gray-700'
              }`}
            >
              <Settings size={18} />
      ...
      <div className={`md:hidden border-t-2 transition-all duration-300 ${
        isOnamPage 
          ...
          : 'border-serene-200 dark:border-gray-700 bg-gradient-to-r from-serene-50 to-backwater-50 dark:from-gray-800 dark:to-gray-900'
      }`}>
              ...
              className={`flex items-center space-x-3 px-4 py-3 rounded-xl text-base font-bold transition-all duration-300 ${
                ...
                (path === '/events' && (location.pathname === '/onam-2025' || location.pathname === '/sadya-registration' || location.pathname === '/cultural-events'))
                  ? isOnamPage
                    ...
                    : 'bg-gradient-to-r from-serene-500 to-backwater-500 dark:from-serene-400 dark:to-backwater-400 text-white shadow-lg'
                  : `text-gray-700 dark:text-gray-300 transition-all duration-300 ${
                      isOnamPage
                        ...
                        : 'hover:text-serene-700 dark:hover:text-serene-400 hover:bg-gradient-to-r hover:from-serene-100 hover:to-backwater-100 dark:hover:from-gray-700 dark:hover:to-gray-600'
                    }`
              }`}
            >
              <Icon size={20} />
          ...
          <Link
            ...
            className={`flex items-center space-x-3 px-4 py-3 rounded-xl text-base font-bold text-white shadow-lg transition-all duration-300 ${
              isOnamPage
                ...
                : 'bg-gradient-to-r from-serene-500 to-sage-500 dark:from-serene-400 dark:to-sage-400'
            }`}
          >
            <Users size={20} />
            <span>Register</span>
