...
const Homepage: React.FC = () => {
  return (
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden bg-warm-gradient dark:from-charcoal-800 dark:via-charcoal-700 dark:to-charcoal-900">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-2 font-serif">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-800 via-red-700 to-orange-800 dark:from-amber-400 dark:via-red-400 dark:to-orange-400">
                Infinity Malayalees
              </span>
            </h1>
            ...
            <div className="mb-4">
              <span className="text-lg md:text-xl text-amber-900 dark:text-amber-200 font-sans font-medium block">
            ...
            <div className="mb-8">
              <span className="text-base md:text-lg text-amber-800 dark:text-amber-300 font-malayalam font-medium block">
            ...
            <div className="bg-orange-50/90 dark:bg-charcoal-800/80 rounded-3xl p-8 mb-8 border-2 border-orange-400 dark:border-orange-500 shadow-2xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                <div className="bg-white dark:bg-charcoal-700 rounded-xl p-4 border border-orange-300 dark:border-orange-500 flex flex-col items-center">
              ...
              <Link
                to="/onam-2025"
                className="inline-flex items-center px-10 py-5 rounded-full bg-gradient-to-r from-orange-500 via-red-500 to-amber-600 dark:from-orange-500 dark:via-red-500 dark:to-amber-600 text-white font-bold text-xl hover:from-orange-600 hover:via-red-600 hover:to-amber-700 dark:hover:from-orange-600 dark:hover:via-red-600 dark:hover:to-amber-700 transform hover:scale-105 transition-all duration-300 shadow-2xl"
              >
      ...
      <section className="py-16 bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 dark:from-charcoal-800 dark:via-charcoal-700 dark:to-charcoal-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-orange-50 dark:bg-charcoal-700 rounded-2xl p-8 border-2 border-orange-300 dark:border-orange-500 hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
              ...
              <h3 className="text-xl font-bold text-orange-800 dark:text-orange-200 mb-4">🍛 Authentic Traditions</h3>
            ...
            <div className="bg-amber-50 dark:bg-charcoal-700 rounded-2xl p-8 border-2 border-amber-300 dark:border-amber-500 hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
            ...
            <div className="bg-yellow-50 dark:bg-charcoal-700 rounded-2xl p-8 border-2 border-yellow-300 dark:border-yellow-500 hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
              ...
              <h3 className="text-xl font-bold text-yellow-800 dark:text-yellow-200 mb-4">📅 Year-Round Events</h3>
              <p className="text-stone-700 dark:text-stone-200 mb-4 font-medium">
